...
| 4 | **Paid By Draft** | `PyMuPDF_Parser` | Yes | `Candidate details\Akshay` | `UtilityBill (1).pdf` |
...
| 7 | **Sr. Full Stack Developer** | `Docx_Parser` | No | `Candidate details\Eswar_Naveen_Java` | `Eswar Naveen java full stack.docx` |
